            ...
            <div className="max-w-7xl mx-auto w-full space-y-8">
                ...
                <div className="grid lg:grid-cols-2 gap-12 items-center">
                    ...
                    <div>
                        ...
                        >
                            <span className="text-xs font-bold tracking-[0.2em] text-slate-400 uppercase mb-6 block">SERVICES</span>
                            ...
                            {[
                                ...
                                >
                                    ...
                                    <p className="text-slate-700 font-medium">
                                        <span className="font-bold text-slate-900">{item.title}</span> {item.text}
                                    </p>
                                </motion.div>
                            ))}
                        </div>
                        ...
                        <div className="grid sm:grid-cols-2 gap-6">
                            ...
                            >
                                ...
                                <h3 className="text-lg font-bold text-slate-900 mb-2">Audience Analytics</h3>
                            ...
                            >
                                ...
                                <h3 className="text-lg font-bold text-slate-900 mb-2">Organic Reach</h3>
                                <p className="text-sm text-slate-600 leading-relaxed">
                    ...
                    <motion.div
                        ...
                        viewport={{ once: true }}
                        transition={{ delay: 0.1 }}
                        className="bg-[#649FFF] rounded-[32px] p-6"
                    >
                        <div className="mb-6">
                            <h3 className="text-xl font-bold text-white mb-2">24/7 Community Management.</h3>
                            <p className="text-sm text-white/90">Your account grows while you sleep. Never miss a DM or comment again.</p>
                        </div>
                ...
                <div className="grid md:grid-cols-2 gap-8">
                    ...
                    <motion.div
                        ...
                        className="bg-[#649FFF] rounded-[32px] p-6"
                    >
                        <h3 className="text-xl font-bold text-white mb-2">Viral Growth Strategy</h3>
                        <p className="text-sm text-white/90 mb-6">Data-backed roadmaps to skyrocket your follower count.</p>
                    ...
                    >
                        ...
                        <p className="text-sm text-white/90 mb-6">Generate weeks of trending social content in seconds.</p>

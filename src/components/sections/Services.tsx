    ...
    return (
        <section id="services" className="py-24 px-6 bg-white">
            <div className="max-w-7xl mx-auto">
                ...
                >
                    <span className="text-xs font-bold tracking-[0.2em] text-slate-400 uppercase mb-6 block">BENEFITS</span>
                    <h2 className="text-4xl md:text-5xl lg:text-6xl font-bold text-slate-900 leading-tight mb-6">
                        Stop switching tools.<br />
                        Start driving <span className="inline-flex items-center gap-2 bg-[#0037FF] text-white px-3 py-1 rounded-xl align-middle text-3xl md:text-5xl shadow-lg shadow-blue-500/30 transform -rotate-2"><TrendingUp size="1em" /> growth.</span>
                    </h2>
                </motion.div>
                ...
                <div className="grid lg:grid-cols-3 gap-8">
                    ...
                    >
                        <div className="w-full aspect-square bg-white rounded-3xl shadow-sm border border-slate-200/50 mb-8 relative overflow-hidden p-6 flex flex-col justify-end">
                            ...
                            <div className="absolute top-6 left-6 right-6">
                                <p className="text-slate-400 text-xs font-medium mb-1">Total Network</p>
                                <div className="flex items-center gap-3">
                                    <span className="text-3xl font-bold text-slate-900">145.2k</span>
                                    <motion.span
                                        initial={{ scale: 0, opacity: 0 }}
                                        whileInView={{ scale: 1, opacity: 1 }}
                                        transition={{ delay: 0.5, type: 'spring', stiffness: 200 }}
                                        viewport={{ once: true }}
                                        className="bg-blue-100 text-[#0037FF] text-xs font-bold px-2 py-1 rounded-lg"
                                    >
                                        +12% Growth
                                    </motion.span>
                                </div>
                        ...
                        <h3 className="text-xl font-bold text-slate-900 mb-3">Growth Analytics</h3>
                    ...
                    >
                        ...
                        <h3 className="text-xl font-bold text-slate-900 mb-3">Multi-Platform Strategy</h3>
                        <p className="text-slate-500 leading-relaxed text-sm">
                    ...
                    >
                        ...
                        <h3 className="text-xl font-bold text-slate-900 mb-3">Organic Drip Delivery</h3>
                        <p className="text-slate-500 leading-relaxed text-sm">
